...
sap.ui.controller("SelfServicePortal.view.Detail", {
	...
	handleApprove: function(evt) {
		...
		var SubmitModel = new sap.ui.model.odata.ODataModel(sServiceUrl, true, "JHO", "jeremy98");
	...
	handleCCSubmit: function(evt) {
		...
		var sServiceUrl = "http://fiodnap1dv1.ca.goldcorp.net:8000/sap/opu/odata/sap/ZSRV_SSOW_SRV";
		var CCModel = new sap.ui.model.odata.ODataModel(sServiceUrl, true, "JHO", "jeremy98");
		var tempContext = this;
	...
	handleWOSubmit: function(evt) {
		...
		var sServiceUrl = "http://fiodnap1dv1.ca.goldcorp.net:8000/sap/opu/odata/sap/ZSRV_SSOW_SRV";
		var WOModel = new sap.ui.model.odata.ODataModel(sServiceUrl, true, "JHO", "jeremy98");
		var tempContext = this;
	...
	handleMaterialAdd: function(evt) {
		...
		var sServiceUrl = "http://fiodnap1dv1.ca.goldcorp.net:8000/sap/opu/odata/sap/ZSRV_SSOW_SRV";
		var MatModel = new sap.ui.model.odata.ODataModel(sServiceUrl, true, "JHO", "jeremy98");
		var tempContext = this;
